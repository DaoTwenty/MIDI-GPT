...
|---|---|---|---|---|---|
| `yellow_medium` | 4, 8 | no | no | 32 | [yellow_medium-final.safetensors](https://huggingface.co/Metacreation/MIDI-GPT/resolve/main/yellow_medium-final.safetensors) |
...
| `prism_medium` | 4, 8, 12, 16 | no | no | 32 | [prism_medium-step58000.safetensors](https://huggingface.co/Metacreation/MIDI-GPT/resolve/main/prism_medium-step58000.safetensors) — training in progress |
| `expressive_medium` | 4, 8, 12, 16 | no | yes | 128 | [expressive_medium-step56000.safetensors](https://huggingface.co/Metacreation/MIDI-GPT/resolve/main/expressive_medium-step56000.safetensors) — training in progress |
...
| `mask_mode` | yellow_medium | prism_medium | expressive_medium |
|---|---|---|---|
...
| `model_dim` | yellow_medium | prism_medium | expressive_medium |
|---|---|---|---|
| 4 | yes | yes | yes |
| 8 | yes | yes | yes |
| 12 | no | yes | yes |
