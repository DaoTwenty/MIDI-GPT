...
class TrackPrompt:
    id: int
    # Bars to GENERATE (AR targets when autoregressive=True, Humanize targets
    # when humanize=True, infill targets otherwise).
    bars: list[int]
    autoregressive: bool = False
    ignore: bool = False
    # Humanize: `bars` must already contain real notes (pitch/onset/duration
    # fixed) whose Velocity/microtiming(Delta) tokens are regenerated by the
    # model. Mutually exclusive with autoregressive and ignore. Requires
    # supports_humanize=true in the encoder config.
    humanize: bool = False
